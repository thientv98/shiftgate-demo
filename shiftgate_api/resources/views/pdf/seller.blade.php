...
<body>
    <div class="container">
        ...
        <div class="row pt-3 font-size-15">
            <div class="col col-12">
                ...
                <div class="row">
                    ...
                    <div class="col col-5 px-0 border-top border-right background-3">
                    </div>
                    ...
                    <div class="col col-5 pl-0">
                        <p class="mb-0 border-top border-right background-3 w-100 h-100"></p>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col col-2 px-0 border-top border-right background-3">
                    </div>
                    <div class="col col-1 px-0">
                ...
                <div class="row">
                    ...
                    <div class="col col-2 px-0 border-top border-right border-bottom background-3">
                    </div>
                    <div class="col col-1 px-0">
                    ...
                    <div class="col col-1 px-0">
                        <p class="background-2 text-center border-top border-bottom border-right mb-0">車台No.</p>
                    </div>
                    <div class="col col-5 pl-0">
                        <p class="mb-0 border-top border-right border-bottom background-3 w-100 h-100"></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row pt-3 px-3">
            <div class="col col-6">
                ...
                <div class="w-100 pt-4">
                    <div class="row pr-3">
                        <div class="col col-7 background-1 border-left border-right border-top">
                            <p class="mb-0 text-center font-weight-bold text-white">諸費用内訳</p>
                        </div>
        ...
        <div class="row pt-3 px-3 pb-5">
            <div class="col col-12 border-black" style="border-bottom: 0px">
