...
$userDirectory = isset($_COOKIE['IsAuthorizedFolder']) ? $_COOKIE['IsAuthorizedFolder'] : '';
...
$config['backends']['default'] = array(
    'name'         => 'default',
    'adapter'      => 'local',
    'baseUrl'      => env('APP_URL') . '/userfiles/' . $userDirectory,
    'root'         => public_path('/userfiles/' . $userDirectory),
    'chmodFiles'   => 0777,
    'chmodFolders' => 0755,
